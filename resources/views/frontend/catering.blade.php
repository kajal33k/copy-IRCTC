...
@section('content')
    <!-- Hero Section -->
    <section class="relative h-screen w-full bg-cover bg-center flex items-center justify-center text-white"
        style="background-image: url('https://cdn.pixabay.com/photo/2017/11/25/17/17/sandwich-2977251_1280.jpg');">
        <div class="absolute inset-0 bg-black bg-opacity-50"></div>

        <div class="relative z-10 text-center px-4 max-w-2xl w-full">
            <!-- Logo -->
            <div class="flex justify-center mb-6">
                <img src="https://cdn.pixabay.com/photo/2017/11/25/17/17/sandwich-2977251_1280.jpg" alt="Logo"
    ...
    <div class="bg-white shadow-sm p-6 flex flex-col md:flex-row items-center justify-between border-b border-gray-200">
        <div class="flex items-center space-x-4">
            <img src="https://cdn.pixabay.com/photo/2022/10/05/16/37/train-7501073_1280.jpg" alt="IRCTC Logo"
                class="w-16 h-16">
            <div>
                <h1 class="text-xl md:text-2xl font-bold text-blue-800">Indian Railway Catering and Tourism Corporation
                    Limited</h1>
                <p class="text-sm text-gray-500">A Government of India Enterprise</p>
            </div>
        </div>
        <div class="mt-4 md:mt-0">
            <p class="text-center md:text-right text-lg font-medium text-gray-700">Official website of Indian Railways and
                IRCTC to order food on trains</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden mx-4 my-10 md:mx-auto max-w-5xl">
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="h-64 md:h-auto">
                <img src="https://cdn.pixabay.com/photo/2022/09/24/15/12/chair-circle-7476562_1280.jpg" alt="Group Food"
            ...
            <div class="p-6 flex flex-col justify-center">
                <div class="flex items-center space-x-3 mb-4">
                    <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M17 20h5v-2a4 4 0 00-4-4h-1m-4 6H7m4-6a4 4 0 00-4-4H6a4 4 0 00-4 4v2h5m6 0h1a4 4 0 014 4v2m-4-6V4a4 4 0 10-8 0v10">
                        </path>
                    </svg>
                    <h2 class="text-2xl font-semibold text-gray-800">Group Orders</h2>
                </div>
                <p class="text-gray-600 mb-6 text-base leading-relaxed">
                    Ordering for a group of more than 15 people? Easily place group orders, get assisted ordering, and
                    custom prices when ordering in bulk quantities.
                </p>
                <a href="#"
                    class="inline-block bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-6 rounded-lg transition duration-300 ease-in-out w-max">
                    GROUP BOOKING
                </a>
            </div>
        </div>
    ...
    <section class="max-w-7xl mx-auto p-4 md:p-8">
        <div
            class="bg-white rounded-xl shadow-md overflow-hidden flex flex-col md:flex-row items-center justify-between p-6">
            <div class="flex-1">
                <span class="inline-block bg-gray-200 text-gray-700 text-xs font-medium px-3 py-1 rounded-full mb-2">New
                    Arrival</span>
            ...
            <div class="w-full md:w-auto mt-6 md:mt-0">
                <img src="https://cdn.pixabay.com/photo/2017/12/10/14/47/pizza-3010062_1280.jpg" alt="IRCTC Special Meal"
                    class="w-full max-w-xs mx-auto md:mx-0 md:max-w-sm object-contain">
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 md:px-8 pb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
                <img src="https://cdn.pixabay.com/photo/2017/12/10/14/47/pizza-3010062_1280.jpg" alt="Domino's Pizza"
                    class="w-24 h-auto mx-auto">
            </div>
            <div class="bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
                <img src="https://cdn.pixabay.com/photo/2017/12/10/14/47/pizza-3010062_1280.jpg" alt="Lunch Box"
                    class="w-24 h-auto mx-auto">
            </div>
            <div class="bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
                <img src="https://cdn.pixabay.com/photo/2017/12/10/14/47/pizza-3010062_1280.jpg" alt="Behrouz Biryani"
                    class="w-24 h-auto mx-auto">
            </div>
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div class="flex flex-col items-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/891/891462.png" alt="Choose an outlet"
                        class="w-20 h-20 mb-4">
                    <div
                        class="flex items-center justify-center bg-orange-500 text-white font-bold w-10 h-10 rounded-full mb-2">
                        1</div>
                ...
                <!-- Step 2 -->
                <div class="flex flex-col items-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/1036/1036395.png" alt="Complete Order"
                        class="w-20 h-20 mb-4">
                    <div
                        class="flex items-center justify-center bg-orange-500 text-white font-bold w-10 h-10 rounded-full mb-2">
                        2</div>
                ...
                <!-- Step 3 -->
                <div class="flex flex-col items-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/1046/1046784.png" alt="Enjoy Tasty Food"
                        class="w-20 h-20 mb-4">
                    <div
                        class="flex items-center justify-center bg-orange-500 text-white font-bold w-10 h-10 rounded-full mb-2">
                        3</div>
    ...
    <section class="bg-white py-12">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div
                class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 items-center justify-center text-center">

                <!-- Partner Logos -->
                <img src="https://cdn.pixabay.com/photo/2021/05/18/15/15/pasta-6263653_1280.jpg" alt="Domino's"
                    class="mx-auto h-12 md:h-16 object-contain">
                <img src="https://cdn.pixabay.com/photo/2016/04/15/17/23/green-asparagus-1331460_1280.jpg" alt="Zomato"
                    class="mx-auto h-12 md:h-16 object-contain">
                <img src="https://cdn.pixabay.com/photo/2020/03/22/16/18/bread-4957679_1280.jpg" alt="Swiggy"
                    class="mx-auto h-12 md:h-16 object-contain">
                <img src="https://cdn.pixabay.com/photo/2022/05/27/10/35/strawberry-7224875_1280.jpg" alt="Oven Story"
                    class="mx-auto h-12 md:h-16 object-contain">
                <img src="https://cdn.pixabay.com/photo/2018/07/03/03/48/avocados-3513048_1280.jpg" alt="Faasos"
                    class="mx-auto h-12 md:h-16 object-contain">

                <img src="https://cdn.pixabay.com/photo/2024/04/01/06/57/cookies-8668140_1280.jpg" alt="Lunch Box"
                    class="mx-auto h-12 md:h-16 object-contain">
                <img src="https://cdn.pixabay.com/photo/2023/06/22/22/29/cookies-8082386_1280.jpg" alt="Behrouz"
                    class="mx-auto h-12 md:h-16 object-contain">
                <img src="https://cdn.pixabay.com/photo/2017/03/26/11/53/hors-doeuvre-2175326_1280.jpg" alt="Eat Sure"
                    class="mx-auto h-12 md:h-16 object-contain">
            </div>
        </div>
    </section>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div class="flex justify-center lg:justify-start space-x-10 text-center">
                            ...
                            <div>
                                <div class="text-4xl text-green-600 mb-2">
                                    <svg class="w-10 h-10 mx-auto" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M21 6h-5V4a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14l4-4h9a2 2 0 0 0 2-2V8h3v11H7v2h14a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z" />
                                    </svg>
                                </div>
                            ...
                            <div>
                                <div class="text-4xl text-orange-500 mb-2">
                                    <svg class="w-10 h-10 mx-auto" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M20 8h-3V5H7v3H4l2 12h12l2-12zM9 7h6v1H9V7zm1 8H9v-2h1v2zm5 0h-1v-2h1v2z" />
                                    </svg>
                                </div>
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <p class="text-gray-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
                                "Great experience. I would suggest travellers to use this app and get hot and tasty food
                                delivered on your seat. Loved the quality of food delivered. Thanks IRCTC for this
                                initiative."
                            </p>
                        </div>
                    </div>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div class="md:w-1/2">
            ...
            <p class="text-gray-700 mb-6 leading-relaxed">
                ...
                faster load times & fluid animations, the app is crafted to delight you with a great eCatering order
                experience.
            </p>
            <div class="flex gap-4">
                <a href="#">
                    <img src="https://cdn.pixabay.com/photo/2021/12/05/16/08/corona-6848115_1280.jpg" alt="App Store"
                        class="h-12">
                </a>
                <a href="#">
                    <img src="https://cdn.pixabay.com/photo/2021/12/05/16/08/corona-6848115_1280.jpg" alt="Google Play"
                        class="h-12">
                </a>
            </div>
        </div>
        ...
        <div class="md:w-1/2 flex justify-center">
            <img src="https://cdn.pixabay.com/photo/2021/12/05/16/08/corona-6848115_1280.jpg"
                alt="Food on Track App Screenshot" class="max-w-xs w-full rounded-xl shadow-xl">
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="bg-gradient-to-br from-red-600 to-red-800 p-6 md:p-8 text-white">
                    <div class="h-full flex flex-col justify-between">
                        <div>
                            <h2 class="text-xl md:text-2xl font-bold mb-4 font-baskerville">Are you a restaurant owner?
                            </h2>
                            <h3 class="text-lg md:text-xl font-semibold mb-6">Register as a vendor</h3>
                            <p class="text-sm md:text-base opacity-90 mb-8">We are always looking to partner with reputed
                                and quality restaurants</p>
                        </div>
                        <button
                            class="w-full md:w-auto bg-white text-red-700 hover:bg-gray-100 font-bold py-3 px-6 rounded-full transition duration-300 transform hover:scale-105">
                            REGISTER NOW
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-900 to-blue-700 p-6 md:p-8 text-white">
                    <div class="h-full flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-sm md:text-base opacity-90 mb-8">Experience a comprehensive news platform with
                                Times of India, offering unparalleled coverage, analysis, and detailed insights</p>
                        </div>
                        <button
                            class="w-full md:w-auto bg-white text-blue-800 hover:bg-gray-100 font-bold py-3 px-6 rounded-full transition duration-300 transform hover:scale-105">
                            EXPLORE NOW
                        </button>
                    </div>
                </div>
    ...
    <div class="max-w-6xl mx-auto p-4 md:p-8">
        ...
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold mb-4 font-baskerville">News and Blogs <span
                    class="gradient-text">About eCatering</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold mt-2 mb-4 font-baskerville">Mahakumbh Mela 2025: A Spiritual Journey
                        Enhanced by IRCTC eCatering</h3>
                    <p class="text-gray-600 mb-6">The Mahakumbh Mela 2025, one of the largest religious gatherings in the
                        world, is a grand confluence of spirituality, culture, and devotion.</p>
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold mt-2 mb-4 font-baskerville">IRCTC eCatering: Your Ultimate Destination for
                        New Year 2025 Food on...</h3>
                    <p class="text-gray-600 mb-6">New Year is about new beginnings, joy, and memorable celebrations. The
                        fresh Year is a time for fresh beginnings, joy, and...</p>
                    <a href="#" class="flex items-center text-red-600 font-semibold hover:text-red-800">
                        Read More
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold mt-2 mb-4 font-baskerville">Celebrate Christmas with Delicious Cakes
                        Delivered to Your Train Seat by...</h3>
                    <p class="text-gray-600 mb-6">Christmas is a time of joy, family, and, of course, delightful treats!
                        One of the best parts of this festive season is indulging in...</p>
                    <a href="#" class="flex items-center text-red-600 font-semibold hover:text-red-800">
                        Read More
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
        ...
        <div class="text-center">
            <button
                class="bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white font-bold py-3 px-8 rounded-full transition duration-300 transform hover:scale-105 shadow-md">
